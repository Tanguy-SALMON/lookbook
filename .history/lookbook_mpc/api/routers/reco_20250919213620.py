...
async def get_similar_outfits(
    item_id: int,
    limit: int = Query(3, ge=1, le=5, description="Number of similar outfits to return")
) -> Dict[str, Any]:
    """
    Get outfits similar to a specific item.

    Args:
        item_id: ID of the item to find similar outfits for
        limit: Maximum number of similar outfits to return

    Returns:
        Similar outfit recommendations
    """
    try:
        logger.info("Getting similar outfits", item_id=item_id, limit=limit)

        # Mock similar outfits
        similar_response = {
            "based_on_item": item_id,
            "similar_outfits": [
                {
                    "items": [
                        {
                            ...
                            "sku": "1295990044",
                            "role": "top",
                            "image_url": "https://example.com/images/y780z9a0b1c2d3e4f5g6.jpg",
                            "title": "Similar Style Top",
                            "price": 45.99,
                            "score": 0.72,
                        ...
                        },
                        {
                            ...
                            "sku": "1295990055",
                            "role": "bottom",
                            "image_url": "https://example.com/images/h790i8j9k0l1m2n3o4p5.jpg",
                            "title": "Matching Bottom",
                            "price": 65.99,
                            "score": 0.70,
                    ...
                    "score": 0.71,
                    "rationale": "Similar style and color coordination to the original item",
                    "similarity_to_original": 0.83
                }
            ],
            "limit": limit
        }
        ...
        logger.error("Error getting similar outfits", error=str(e))
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Failed to get similar outfits: {str(e)}"
        )